...
public:
    ...
    //    ofParameter<float> read_exposureValue;
    ...
    void setup(string _name, int _camID){
        ...
        parameters.add(exposureValue.set("exposureValue",0.935,0.85,0.999999));
        //        parameters.add(read_exposureValue.set("read expo",0.935,0.85,0.999999));
    ...
    void update(){
        ...
        //        read_exposureValue = uvcControl.getExposure(); 
        //        cout<<"read_exposureValue "<<read_exposureValue<<" r "<<uvcControl.getExposure()<<endl;
    }
    
    void changeCamSettings(){
        //        ofLog()<<"changeCamSettings";
        if(bShowGUI == false){
        ...
        if(aWhiteBalance == false && whiteBalanceValue != old_whiteBalanceValue){
            ...
            ofLog()<<"old_whiteBalanceValue "<<old_whiteBalanceValue;
            old_whiteBalanceValue = whiteBalanceValue;
